...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,dt=`# Chapter: Week 5 - Clothes & Shopping
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,ut=`# Chapter: Week 10 - Health & Body
meta:
  id: health-and-body
  title:
    en: "Health & Body"
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,pt=`# Chapter: Week 8 - Hobbies & Free Time
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,mt=`# Chapter: Week 1 - The Morning Routine
meta:
  id: morning-routine
  title:
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,zt=`# Chapter: Week 6 - Time & Schedules
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,jt=`# Chapter: Week 3 - Future & Plans
meta:
  id: future-and-plans
  title:
    en: "Future & Plans"
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,yt=`# Chapter: Week 4 - Experiences & Achievements
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,wt=`# Chapter: Week 5 - Travel Problems & Complaints
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,vt=`# Chapter: Week 6 - Opinions & Disagreement
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,kt=`# Chapter: Week 8 - Entertainment & Reviews
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,bt=`# Chapter: Week 1 - Identity & Background
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,It=`# Chapter: Week 2 - Telling Stories
meta:
  id: telling-stories
  title:
    en: "Telling Stories"
...
quiz:
  questionsPerRound: 5
  xpReward: 25
`,_t=`# Chapter: Comprehension Check
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,St=`# Chapter: Me, You, and Professionals
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 20
`,Tt=`# Chapter: Mixed Practice (Dialogue Flow)
meta:
...
quiz:
  questionsPerRound: 5
  xpReward: 20`,Ct=`# Chapter: The Negative (Not X)
meta:
  id: negative-not-x
  title:
...
quiz:
  questionsPerRound: 5
  xpReward: 20`,Et=`# Chapter: Shadowing (Speed & Rhythm)
...
quiz:
  questionsPerRound: 5
  xpReward: 20`,Lt=`# Chapter: Stating Facts
meta:
  id: stating-facts
  title:
    en: "Stating Facts"
...
quiz:
  questionsPerRound: 5
  xpReward: 20`,Pt=`# Chapter: Yes / No Questions
...
quiz:
  questionsPerRound: 5
  xpReward: 20`,Dt=`# Pre-Lesson: Hiragana Vowels & K-row
meta:
...
quiz:
  ...
  questionTypes:
    ...
    - "reading_to_char"
    - "audio_to_char"
`,Mt=`# Pre-Lesson: Hiragana S-row & T-row
meta:
  id: hiragana-02-s-t
  title:
...
quiz:
  ...
  questionTypes:
    ...
    - "reading_to_char"
    - "audio_to_char"
`,Rt=`# Pre-Lesson: Hiragana N-row & H-row
meta:
  id: hiragana-03-n-h
  title:
...
quiz:
  ...
  questionTypes:
    ...
    - "reading_to_char"
    - "audio_to_char"
`,Ot=`# Pre-Lesson: Hiragana M-row, Y-row, R-row, W-row & N
meta:
...
quiz:
  ...
  questionTypes:
    ...
    - "reading_to_char"
    - "audio_to_char"
`,Nt=`# Pre-Lesson: Hiragana Dakuten & Handakuten
meta:
...
quiz:
  ...
  questionTypes:
    ...
    - "audio_to_char"
    - "tone_id"
`,Ft=`# Pre-Lesson: Pinyin Initials (Group 1)
meta:
...
quiz:
  ...
  questionTypes:
    ...
    - "reading_to_char"
    - "audio_to_char"
`,Yt=`# Pre-Lesson: Pinyin Finals (Common)
meta:
  id: pinyin-03-finals
  title:
...
quiz:
  ...
  questionTypes:
    ...
    - "reading_to_char"
    - "audio_to_char"
`;function le(n){return typeof n>"u"||n===null}function qt(n){return typeof n=="object"&&n!==null}function Bt(n){return Array.isArray(n)?n:le(n)?[]:[n]}function Ut(n,e){var t,i,a,o;if(e)for(o=Object.keys(e),t=0,i=o.length;t<i;t+=1)a=o[t],n[a]=e[a];return n}function Gt(n,e){var t="",i;for(i=0;i<e;i+=1)t+=n;return t}function Kt(n){return n===0&&Number.NEGATIVE_INFINITY===1/n}var Vt=le,Jt=qt,Xt=Bt,Qt=Gt,$t=Kt,Zt=Ut,x={isNothing:Vt,isObject:Jt,toArray:Xt,repeat:Qt,isNegativeZero:$t,extend:Zt};function ce(n,e){var t="",i=n.reason||"(unknown reason)";return n.mark?(n.mark.name&&(t+='in "'+n.mark.name+'" '),t+="("+(n.mark.line+1)+":"+(n.mark.column+1)+")",!e&&n.mark.snippet&&(t+=`

`+n.mark.snippet),i+" "+t):i}function X(n,e){Error.call(this),this.name="YAMLException",this.reason=n,this.mark=e,this.message=ce(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}X.prototype=Object.create(Error.prototype);X.prototype.constructor=X;X.prototype.toString=function(e){return this.name+": "+ce(this,e)};var A=X;function un(n,e,t,i,a){var o="",r="",s=Math.floor(a/2)-1;return i-e>s&&(o=" ... ",e=i-s+o.length),t-i>s&&(r=" ...",t=i+s-r.length),{str:o+n.slice(e,t).replace(/\t/g,"→")+r,pos:i-e+o.length}}function pn(n,e){return x.repeat(" ",e-n.length)+n}function ni(n,e){if(e=Object.create(e||null),!n.buffer)return null;e.maxLength||(e.maxLength=79),typeof e.indent!="number"&&(e.indent=1),typeof e.linesBefore!="number"&&(e.linesBefore=3),typeof e.linesAfter!="number"&&(e.linesAfter=2);for(var t=/\r?\n|\r|\0/g,i=[0],a=[],o,r=-1;o=t.exec(n.buffer);)a.push(o.index),i.push(o.index+o[0].length),n.position<=o.index&&r<0&&(r=i.length-2);r<0&&(r=i.length-1);var s="",h,d,l=Math.min(n.line+e.linesAfter,a.length).toString().length,c=e.maxLength-(e.indent+l+3);for(h=1;h<=e.linesBefore&&!(r-h<0);h++)d=un(n.buffer,i[r-h],a[r-h],n.position-(i[r]-i[r-h]),c),s=x.repeat(" ",e.indent)+pn((n.line-h+1).toString(),l)+" | "+d.str+`
`+s;for(d=un(n.buffer,i[r],a[r],n.position,c),s+=x.repeat(" ",e.indent)+pn((n.line+1).toString(),l)+" | "+d.str+`
`,s+=x.repeat("-",e.indent+l+3+d.pos)+`^
`,h=1;h<=e.linesAfter&&!(r+h>=a.length);h++)d=un(n.buffer,i[r+h],a[r+h],n.position-(i[r]-i[r+h]),c),s+=x.repeat(" ",e.indent)+pn((n.line+h+1).toString(),l)+" | "+d.str+`
`;return s.replace(/\n$/,"")}var ei=ni,ti=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],ii=["scalar","sequence","mapping"];function ai(n){var e={};return n!==null&&Object.keys(n).forEach(function(t){n[t].forEach(function(i){e[String(i)]=t})}),e}function ri(n,e){if(e=e||{},Object.keys(e).forEach(function(t){if(ti.indexOf(t)===-1)throw new A('Unknown option "'+t+'" is met in definition of "'+n+'" YAML type.')}),this.options=e,this.tag=n,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(t){return t},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.representName=e.representName||null,this.defaultStyle=e.defaultStyle||null,this.multi=e.multi||!1,this.styleAliases=ai(e.styleAliases||null),ii.indexOf(this.kind)===-1)throw new A('Unknown kind "'+this.kind+'" is specified for "'+n+'" YAML type.')}var b=ri;function Bn(n,e){var t=[];return n[e].forEach(function(i){var a=t.length;t.forEach(function(o,r){o.tag===i.tag&&o.kind===i.kind&&o.multi===i.multi&&(a=r)}),t[a]=i}),t}function oi(){var n={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},e,t;function i(a){a.multi?(n.multi[a.kind].push(a),n.multi.fallback.push(a)):n[a.kind][a.tag]=n.fallback[a.tag]=a}for(e=0,t=arguments.length;e<t;e+=1)arguments[e].forEach(i);return n}function Sn(n){return this.extend(n)}Sn.prototype.extend=function(e){var t=[],i=[];if(e instanceof b)i.push(e);else if(Array.isArray(e))i=i.concat(e);else if(e&&(Array.isArray(e.implicit)||Array.isArray(e.explicit)))e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(i=i.concat(e.explicit));else throw new A("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");t.forEach(function(o){if(!(o instanceof b))throw new A("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(o.loadKind&&o.loadKind!=="scalar")throw new A("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(o.multi)throw new A("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(o){if(!(o instanceof b))throw new A("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var a=Object.create(Sn.prototype);return a.implicit=(this.implicit||[]).concat(t),a.explicit=(this.explicit||[]).concat(i),a.compiledImplicit=Bn(a,"implicit"),a.compiledExplicit=Bn(a,"explicit"),a.compiledTypeMap=oi(a.compiledImplicit,a.compiledExplicit),a};var ue=Sn,pe=new b("tag:yaml.org,2002:str",{kind:"scalar",construct:function(n){return n!==null?n:""}}),ge=new b("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(n){return n!==null?n:[]}}),me=new b("tag:yaml.org,2002:map",{kind:"mapping",construct:function(n){return n!==null?n:{}}}),ze=new ue({explicit:[pe,ge,me]});function si(n){if(n===null)return!0;var e=n.length;return e===1&&n==="~"||e===4&&(n==="null"||n==="Null"||n==="NULL")}function hi(){return null}function di(n){return n===null}var fe=new b("tag:yaml.org,2002:null",{kind:"scalar",resolve:si,construct:hi,predicate:di,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function li(n){if(n===null)return!1;var e=n.length;return e===4&&(n==="true"||n==="True"||n==="TRUE")||e===5&&(n==="false"||n==="False"||n==="FALSE")}function ci(n){return n==="true"||n==="True"||n==="TRUE"}function ui(n){return Object.prototype.toString.call(n)==="[object Boolean]"}var je=new b("tag:yaml.org,2002:bool",{kind:"scalar",resolve:li,construct:ci,predicate:ui,represent:{lowercase:function(n){return n?"true":"false"},uppercase:function(n){return n?"TRUE":"FALSE"},camelcase:function(n){return n?"True":"False"}},defaultStyle:"lowercase"});function pi(n){return 48<=n&&n<=57||65<=n&&n<=70||97<=n&&n<=102}function gi(n){return 48<=n&&n<=55}function mi(n){return 48<=n&&n<=57}function zi(n){if(n===null)return!1;var e=n.length,t=0,i=!1,a;if(!e)return!1;if(a=n[t],(a==="-"||a==="+")&&(a=n[++t]),a==="0"){if(t+1===e)return!0;if(a=n[++t],a==="b"){for(t++;t<e;t++)if(a=n[t],a!=="_"){if(a!=="0"&&a!=="1")return!1;i=!0}return i&&a!=="_"}if(a==="x"){for(t++;t<e;t++)if(a=n[t],a!=="_"){if(!pi(n.charCodeAt(t)))return!1;i=!0}return i&&a!=="_"}if(a==="o"){for(t++;t<e;t++)if(a=n[t],a!=="_"){if(!gi(n.charCodeAt(t)))return!1;i=!0}return i&&a!=="_"}}if(a==="_")return!1;for(;t<e;t++)if(a=n[t],a!=="_"){if(!mi(n.charCodeAt(t)))return!1;i=!0}return!(!i||a==="_")}function fi(n){var e=n,t=1,i;if(e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),i=e[0],(i==="-"||i==="+")&&(i==="-"&&(t=-1),e=e.slice(1),i=e[0]),e==="0")return 0;if(i==="0"){if(e[1]==="b")return t*parseInt(e.slice(2),2);if(e[1]==="x")return t*parseInt(e.slice(2),16);if(e[1]==="o")return t*parseInt(e.slice(2),8)}return t*parseInt(e,10)}function ji(n){return Object.prototype.toString.call(n)==="[object Number]"&&n%1===0&&!x.isNegativeZero(n)}var ye=new b("tag:yaml.org,2002:int",{kind:"scalar",resolve:zi,construct:fi,predicate:ji,represent:{binary:function(n){return n>=0?"0b"+n.toString(2):"-0b"+n.toString(2).slice(1)},octal:function(n){return n>=0?"0o"+n.toString(8):"-0o"+n.toString(8).slice(1)},decimal:function(n){return n.toString(10)},hexadecimal:function(n){return n>=0?"0x"+n.toString(16).toUpperCase():"-0x"+n.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),yi=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function wi(n){return!(n===null||!yi.test(n)||n[n.length-1]==="_")}function vi(n){var e,t;return e=n.replace(/_/g,"").toLowerCase(),t=e[0]==="-"?-1:1,"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:t*parseFloat(e,10)}var xi=/^[-+]?[0-9]+e/;function ki(n,e){var t;if(isNaN(n))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===n)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===n)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(x.isNegativeZero(n))return"-0.0";return t=n.toString(10),xi.test(t)?t.replace("e",".e"):t}function bi(n){return Object.prototype.toString.call(n)==="[object Number]"&&(n%1!==0||x.isNegativeZero(n))}var we=new b("tag:yaml.org,2002:float",{kind:"scalar",resolve:wi,construct:vi,predicate:bi,represent:ki,defaultStyle:"lowercase"}),ve=ze.extend({implicit:[fe,je,ye,we]}),xe=ve,ke=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),be=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Ii(n){return n===null?!1:ke.exec(n)!==null||be.exec(n)!==null}function _i(n){var e,t,i,a,o,r,s,h=0,d=null,l,c,p;if(e=ke.exec(n),e===null&&(e=be.exec(n)),e===null)throw new Error("Date resolve error");if(t=+e[1],i=+e[2]-1,a=+e[3],!e[4])return new Date(Date.UTC(t,i,a));if(o=+e[4],r=+e[5],s=+e[6],e[7]){for(h=e[7].slice(0,3);h.length<3;)h+="0";h=+h}return e[9]&&(l=+e[10],c=+(e[11]||0),d=(l*60+c)*6e4,e[9]==="-"&&(d=-d)),p=new Date(Date.UTC(t,i,a,o,r,s,h)),d&&p.setTime(p.getTime()-d),p}function Ai(n){return n.toISOString()}var Ie=new b("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Ii,construct:_i,instanceOf:Date,represent:Ai});function Si(n){return n==="<<"||n===null}var _e=new b("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Si}),Dn=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Ti(n){if(n===null)return!1;var e,t,i=0,a=n.length,o=Dn;for(t=0;t<a;t++)if(e=o.indexOf(n.charAt(t)),!(e>64)){if(e<0)return!1;i+=6}return i%8===0}function Ci(n){var e,t,i=n.replace(/[\r\n=]/g,""),a=i.length,o=Dn,r=0,s=[];for(e=0;e<a;e++)e%4===0&&e&&(s.push(r>>16&255),s.push(r>>8&255),s.push(r&255)),r=r<<6|o.indexOf(i.charAt(e));return t=a%4*6,t===0?(s.push(r>>16&255),s.push(r>>8&255),s.push(r&255)):t===18?(s.push(r>>10&255),s.push(r>>2&255)):t===12&&s.push(r>>4&255),new Uint8Array(s)}function Ei(n){var e="",t=0,i,a,o=n.length,r=Dn;for(i=0;i<o;i++)i%3===0&&i&&(e+=r[t>>18&63],e+=r[t>>12&63],e+=r[t>>6&63],e+=r[t&63]),t=(t<<8)+n[i];return a=o%3,a===0?(e+=r[t>>18&63],e+=r[t>>12&63],e+=r[t>>6&63],e+=r[t&63]):a===2?(e+=r[t>>10&63],e+=r[t>>4&63],e+=r[t<<2&63],e+=r[64]):a===1&&(e+=r[t>>2&63],e+=r[t<<4&63],e+=r[64],e+=r[64]),e}function Li(n){return Object.prototype.toString.call(n)==="[object Uint8Array]"}var Ae=new b("tag:yaml.org,2002:binary",{kind:"scalar",resolve:Ti,construct:Ci,predicate:Li,represent:Ei}),Pi=Object.prototype.hasOwnProperty,Di=Object.prototype.toString;function Mi(n){if(n===null)return!0;var e=[],t,i,a,o,r,s=n;for(t=0,i=s.length;t<i;t+=1){if(a=s[t],r=!1,Di.call(a)!=="[object Object]")return!1;for(o in a)if(Pi.call(a,o))if(!r)r=!0;else return!1;if(!r)return!1;if(e.indexOf(o)===-1)e.push(o);else return!1}return!0}function Ri(n){return n!==null?n:[]}var Se=new b("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Mi,construct:Ri}),Oi=Object.prototype.toString;function Ni(n){if(n===null)return!0;var e,t,i,a,o,r=n;for(o=new Array(r.length),e=0,t=r.length;e<t;e+=1){if(i=r[e],Oi.call(i)!=="[object Object]"||(a=Object.keys(i),a.length!==1))return!1;o[e]=[a[0],i[a[0]]]}return!0}function Hi(n){if(n===null)return[];var e,t,i,a,o,r=n;for(o=new Array(r.length),e=0,t=r.length;e<t;e+=1)i=r[e],a=Object.keys(i),o[e]=[a[0],i[a[0]]];return o}var Te=new b("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Ni,construct:Hi}),Wi=Object.prototype.hasOwnProperty;function Fi(n){if(n===null)return!0;var e,t=n;for(e in t)if(Wi.call(t,e)&&t[e]!==null)return!1;return!0}function Yi(n){return n!==null?n:{}}var Ce=new b("tag:yaml.org,2002:set",{kind:"mapping",resolve:Fi,construct:Yi}),Mn=xe.extend({implicit:[Ie,_e],explicit:[Ae,Se,Te,Ce]}),N=Object.prototype.hasOwnProperty,an=1,Ee=2,Le=3,rn=4,gn=1,qi=2,Un=3,Bi=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Ui=/[\x85\u2028\u2029]/,Gi=/[,\[\]\{\}]/,Pe=/^(?:!|!!|![a-z\-]+!)$/i,De=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Gn(n){return Object.prototype.toString.call(n)}function L(n){return n===10||n===13}function W(n){return n===9||n===32}function S(n){return n===9||n===32||n===10||n===13}function B(n){return n===44||n===91||n===93||n===123||n===125}function Ki(n){var e;return 48<=n&&n<=57?n-48:(e=n|32,97<=e&&e<=102?e-97+10:-1)}function Vi(n){return n===120?2:n===117?4:n===85?8:0}function Ji(n){return 48<=n&&n<=57?n-48:-1}function Kn(n){return n===48?"\0":n===97?"\x07":n===98?"\b":n===116||n===9?"	":n===110?`
`:n===118?"\v":n===102?"\f":n===114?"\r":n===101?"\x1B":n===32?" ":n===34?'"':n===47?"/":n===92?"\\":n===78?"":n===95?" ":n===76?"\u2028":n===80?"\u2029":""}function Xi(n){return n<=65535?String.fromCharCode(n):String.fromCharCode((n-65536>>10)+55296,(n-65536&1023)+56320)}function Me(n,e,t){e==="__proto__"?Object.defineProperty(n,e,{configurable:!0,enumerable:!0,writable:!0,value:t}):n[e]=t}var Re=new Array(256),Oe=new Array(256);for(var Y=0;Y<256;Y++)Re[Y]=Kn(Y)?1:0,Oe[Y]=Kn(Y);function Qi(n,e){this.input=n,this.filename=e.filename||null,this.schema=e.schema||Mn,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=n.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function Ne(n,e){var t={name:n.filename,buffer:n.input.slice(0,-1),position:n.position,line:n.line,column:n.position-n.lineStart};return t.snippet=ei(t),new A(e,t)}function g(n,e){throw Ne(n,e)}function on(n,e){n.onWarning&&n.onWarning.call(null,Ne(n,e))}var Vn={YAML:function(e,t,i){var a,o,r;e.version!==null&&g(e,"duplication of %YAML directive"),i.length!==1&&g(e,"YAML directive accepts exactly one argument"),a=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),a===null&&g(e,"ill-formed argument of the YAML directive"),o=parseInt(a[1],10),r=parseInt(a[2],10),o!==1&&g(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=r<2,r!==1&&r!==2&&on(e,"unsupported YAML version of the document")},TAG:function(e,t,i){var a,o;i.length!==2&&g(e,"TAG directive accepts exactly two arguments"),a=i[0],o=i[1],Pe.test(a)||g(e,"ill-formed tag handle (first argument) of the TAG directive"),N.call(e.tagMap,a)&&g(e,'there is a previously declared suffix for "'+a+'" tag handle'),De.test(o)||g(e,"ill-formed tag prefix (second argument) of the TAG directive");try{o=decodeURIComponent(o)}catch{g(e,"tag prefix is malformed: "+o)}e.tagMap[a]=o}};function O(n,e,t,i){var a,o,r,s;if(e<t){if(s=n.input.slice(e,t),i)for(a=0,o=s.length;a<o;a+=1)r=s.charCodeAt(a),r===9||32<=r&&r<=1114111||g(n,"expected valid JSON character");else Bi.test(s)&&g(n,"the stream contains non-printable characters");n.result+=s}}function Jn(n,e,t,i){var a,o,r,s;for(x.isObject(t)||g(n,"cannot merge mappings; the provided source object is unacceptable"),a=Object.keys(t),r=0,s=a.length;r<s;r+=1)o=a[r],N.call(e,o)||(Me(e,o,t[o]),i[o]=!0)}function U(n,e,t,i,a,o,r,s,h){var d,l;if(Array.isArray(a))for(a=Array.prototype.slice.call(a),d=0,l=a.length;d<l;d+=1)Array.isArray(a[d])&&g(n,"nested arrays are not supported inside keys"),typeof a=="object"&&Gn(a[d])==="[object Object]"&&(a[d]="[object Object]");if(typeof a=="object"&&Gn(a)==="[object Object]"&&(a="[object Object]"),a=String(a),e===null&&(e={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(d=0,l=o.length;d<l;d+=1)Jn(n,e,o[d],t);else Jn(n,e,o,t);else!n.json&&!N.call(t,a)&&N.call(e,a)&&(n.line=r||n.line,n.lineStart=s||n.lineStart,n.position=h||n.position,g(n,"duplicated mapping key")),Me(e,a,o),delete t[a];return e}function Rn(n){var e;e=n.input.charCodeAt(n.position),e===10?n.position++:e===13?(n.position++,n.input.charCodeAt(n.position)===10&&n.position++):g(n,"a line break is expected"),n.line+=1,n.lineStart=n.position,n.firstTabInLine=-1}function v(n,e,t){for(var i=0,a=n.input.charCodeAt(n.position);a!==0;){for(;W(a);)a===9&&n.firstTabInLine===-1&&(n.firstTabInLine=n.position),a=n.input.charCodeAt(++n.position);if(e&&a===35)do a=n.input.charCodeAt(++n.position);while(a!==10&&a!==13&&a!==0);if(L(a))for(Rn(n),a=n.input.charCodeAt(n.position),i++,n.lineIndent=0;a===32;)n.lineIndent++,a=n.input.charCodeAt(++n.position);else break}return t!==-1&&i!==0&&n.lineIndent<t&&on(n,"deficient indentation"),i}function dn(n){var e=n.position,t;return t=n.input.charCodeAt(e),!!((t===45||t===46)&&t===n.input.charCodeAt(e+1)&&t===n.input.charCodeAt(e+2)&&(e+=3,t=n.input.charCodeAt(e),t===0||S(t)))}function On(n,e){e===1?n.result+=" ":e>1&&(n.result+=x.repeat(`
`,e-1))}function $i(n,e,t){var i,a,o,r,s,h,d,l,c=n.kind,p=n.result,u;if(u=n.input.charCodeAt(n.position),S(u)||B(u)||u===35||u===38||u===42||u===33||u===124||u===62||u===39||u===34||u===37||u===64||u===96||(u===63||u===45)&&(a=n.input.charCodeAt(n.position+1),S(a)||t&&B(a)))return!1;for(n.kind="scalar",n.result="",o=r=n.position,s=!1;u!==0;){if(u===58){if(a=n.input.charCodeAt(n.position+1),S(a)||t&&B(a))break}else if(u===35){if(i=n.input.charCodeAt(n.position-1),S(i))break}else{if(n.position===n.lineStart&&dn(n)||t&&B(u))break;if(L(u))if(h=n.line,d=n.lineStart,l=n.lineIndent,v(n,!1,-1),n.lineIndent>=e){s=!0,u=n.input.charCodeAt(n.position);continue}else{n.position=r,n.line=h,n.lineStart=d,n.lineIndent=l;break}}s&&(O(n,o,r,!1),On(n,n.line-h),o=r=n.position,s=!1),W(u)||(r=n.position+1),u=n.input.charCodeAt(++n.position)}return O(n,o,r,!1),n.result?!0:(n.kind=c,n.result=p,!1)}function Zi(n,e){var t,i,a;if(t=n.input.charCodeAt(n.position),t!==39)return!1;for(n.kind="scalar",n.result="",n.position++,i=a=n.position;(t=n.input.charCodeAt(n.position))!==0;)if(t===39)if(O(n,i,n.position,!0),t=n.input.charCodeAt(++n.position),t===39)i=n.position,n.position++,a=n.position;else return!0;else L(t)?(O(n,i,a,!0),On(n,v(n,!1,e)),i=a=n.position):n.position===n.lineStart&&dn(n)?g(n,"unexpected end of the document within a single quoted scalar"):(n.position++,a=n.position);g(n,"unexpected end of the stream within a single quoted scalar")}function na(n,e){var t,i,a,o,r,s;if(s=n.input.charCodeAt(n.position),s!==34)return!1;for(n.kind="scalar",n.result="",n.position++,t=i=n.position;(s=n.input.charCodeAt(n.position))!==0;){if(s===34)return O(n,t,n.position,!0),n.position++,!0;if(s===92){if(O(n,t,n.position,!0),s=n.input.charCodeAt(++n.position),L(s))v(n,!1,e);else if(s<256&&Re[s])n.result+=Oe[s],n.position++;else if((r=Vi(s))>0){for(a=r,o=0;a>0;a--)s=n.input.charCodeAt(++n.position),(r=Ki(s))>=0?o=(o<<4)+r:g(n,"expected hexadecimal character");n.result+=Xi(o),n.position++}else g(n,"unknown escape sequence");t=i=n.position}else L(s)?(O(n,t,i,!0),On(n,v(n,!1,e)),t=i=n.position):n.position===n.lineStart&&dn(n)?g(n,"unexpected end of the document within a double quoted scalar"):(n.position++,i=n.position)}g(n,"unexpected end of the stream within a double quoted scalar")}function ea(n,e){var t=!0,i,a,o,r=n.tag,s,h=n.anchor,d,l,c,p,u,j=Object.create(null),w,m,z,f;if(f=n.input.charCodeAt(n.position),f===91)l=93,u=!1,s=[];else if(f===123)l=125,u=!0,s={};else return!1;for(n.anchor!==null&&(n.anchorMap[n.anchor]=s),f=n.input.charCodeAt(++n.position);f!==0;){if(v(n,!0,e),f=n.input.charCodeAt(n.position),f===l)return n.position++,n.tag=r,n.anchor=h,n.kind=u?"mapping":"sequence",n.result=s,!0;t?f===44&&g(n,"expected the node content, but found ','"):g(n,"missed comma between flow collection entries"),m=w=z=null,c=p=!1,f===63&&(d=n.input.charCodeAt(n.position+1),S(d)&&(c=p=!0,n.position++,v(n,!0,e))),i=n.line,a=n.lineStart,o=n.position,G(n,e,an,!1,!0),m=n.tag,w=n.result,v(n,!0,e),f=n.input.charCodeAt(n.position),(p||n.line===i)&&f===58&&(c=!0,f=n.input.charCodeAt(++n.position),v(n,!0,e),G(n,e,an,!1,!0),z=n.result),u?U(n,s,j,m,w,z,i,a,o):c?s.push(U(n,null,j,m,w,z,i,a,o)):s.push(w),v(n,!0,e),f=n.input.charCodeAt(n.position),f===44?(t=!0,f=n.input.charCodeAt(++n.position)):t=!1}g(n,"unexpected end of the stream within a flow collection")}function ta(n,e){var t,i,a=gn,o=!1,r=!1,s=e,h=0,d=!1,l,c;if(c=n.input.charCodeAt(n.position),c===124)i=!1;else if(c===62)i=!0;else return!1;for(n.kind="scalar",n.result="";c!==0;)if(c=n.input.charCodeAt(++n.position),c===43||c===45)gn===a?a=c===43?Un:qi:g(n,"repeat of a chomping mode identifier");else if((l=Ji(c))>=0)l===0?g(n,"bad explicit indentation width of a block scalar; it cannot be less than one"):r?g(n,"repeat of an indentation width identifier"):(s=e+l-1,r=!0);else break;if(W(c)){do c=n.input.charCodeAt(++n.position);while(W(c));if(c===35)do c=n.input.charCodeAt(++n.position);while(!L(c)&&c!==0)}for(;c!==0;){for(Rn(n),n.lineIndent=0,c=n.input.charCodeAt(n.position);(!r||n.lineIndent<s)&&c===32;)n.lineIndent++,c=n.input.charCodeAt(++n.position);if(!r&&n.lineIndent>s&&(s=n.lineIndent),L(c)){h++;continue}if(n.lineIndent<s){a===Un?n.result+=x.repeat(`
`,o?1+h:h):a===gn&&o&&(n.result+=`
`);break}for(i?W(c)?(d=!0,n.result+=x.repeat(`
`,o?1+h:h)):d?(d=!1,n.result+=x.repeat(`
`,h+1)):h===0?o&&(n.result+=" "):n.result+=x.repeat(`
`,h):n.result+=x.repeat(`
`,o?1+h:h),o=!0,r=!0,h=0,t=n.position;!L(c)&&c!==0;)c=n.input.charCodeAt(++n.position);O(n,t,n.position,!1)}return!0}function Xn(n,e){var t,i=n.tag,a=n.anchor,o=[],r,s=!1,h;if(n.firstTabInLine!==-1)return!1;for(n.anchor!==null&&(n.anchorMap[n.anchor]=o),h=n.input.charCodeAt(n.position);h!==0&&(n.firstTabInLine!==-1&&(n.position=n.firstTabInLine,g(n,"tab characters must not be used in indentation")),!(h!==45||(r=n.input.charCodeAt(n.position+1),!S(r))));){if(s=!0,n.position++,v(n,!0,-1)&&n.lineIndent<=e){o.push(null),h=n.input.charCodeAt(n.position);continue}if(t=n.line,G(n,e,Le,!1,!0),o.push(n.result),v(n,!0,-1),h=n.input.charCodeAt(n.position),(n.line===t||n.lineIndent>e)&&h!==0)g(n,"bad indentation of a sequence entry");else if(n.lineIndent<e)break}return s?(n.tag=i,n.anchor=a,n.kind="sequence",n.result=o,!0):!1}function ia(n,e,t){var i,a,o,r,s,h,d=n.tag,l=n.anchor,c={},p=Object.create(null),u=null,j=null,w=null,m=!1,z=!1,f;if(n.firstTabInLine!==-1)return!1;for(n.anchor!==null&&(n.anchorMap[n.anchor]=c),f=n.input.charCodeAt(n.position);f!==0;){if(!m&&n.firstTabInLine!==-1&&(n.position=n.firstTabInLine,g(n,"tab characters must not be used in indentation")),i=n.input.charCodeAt(n.position+1),o=n.line,(f===63||f===58)&&S(i))f===63?(m&&(U(n,c,p,u,j,null,r,s,h),u=j=w=null),z=!0,m=!0,a=!0):m?(m=!1,a=!0):g(n,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),n.position+=1,f=i;else{if(r=n.line,s=n.lineStart,h=n.position,!G(n,t,Ee,!1,!0))break;if(n.line===o){for(f=n.input.charCodeAt(n.position);W(f);)f=n.input.charCodeAt(++n.position);if(f===58)f=n.input.charCodeAt(++n.position),S(f)||g(n,"a whitespace character is expected after the key-value separator within a block mapping"),m&&(U(n,c,p,u,j,null,r,s,h),u=j=w=null),z=!0,m=!1,a=!1,u=n.tag,j=n.result;else if(z)g(n,"can not read an implicit mapping pair; a colon is missed");else return n.tag=d,n.anchor=l,!0}else if(z)g(n,"can not read a block mapping entry; a multiline key may not be an implicit key");else return n.tag=d,n.anchor=l,!0}if((n.line===o||n.lineIndent>e)&&(m&&(r=n.line,s=n.lineStart,h=n.position),G(n,e,rn,!0,a)&&(m?j=n.result:w=n.result),m||(U(n,c,p,u,j,w,r,s,h),u=j=w=null),v(n,!0,-1),f=n.input.charCodeAt(n.position)),(n.line===o||n.lineIndent>e)&&f!==0)g(n,"bad indentation of a mapping entry");else if(n.lineIndent<e)break}return m&&U(n,c,p,u,j,null,r,s,h),z&&(n.tag=d,n.anchor=l,n.kind="mapping",n.result=c),z}function aa(n){var e,t=!1,i=!1,a,o,r;if(r=n.input.charCodeAt(n.position),r!==33)return!1;if(n.tag!==null&&g(n,"duplication of a tag property"),r=n.input.charCodeAt(++n.position),r===60?(t=!0,r=n.input.charCodeAt(++n.position)):r===33?(i=!0,a="!!",r=n.input.charCodeAt(++n.position)):a="!",e=n.position,t){do r=n.input.charCodeAt(++n.position);while(r!==0&&r!==62);n.position<n.length?(o=n.input.slice(e,n.position),r=n.input.charCodeAt(++n.position)):g(n,"unexpected end of the stream within a verbatim tag")}else{for(;r!==0&&!S(r);)r===33&&(i?g(n,"tag suffix cannot contain exclamation marks"):(a=n.input.slice(e-1,n.position+1),Pe.test(a)||g(n,"named tag handle cannot contain such characters"),i=!0,e=n.position+1)),r=n.input.charCodeAt(++n.position);o=n.input.slice(e,n.position),Gi.test(o)&&g(n,"tag suffix cannot contain flow indicator characters")}o&&!De.test(o)&&g(n,"tag name cannot contain such characters: "+o);try{o=decodeURIComponent(o)}catch{g(n,"tag name is malformed: "+o)}return t?n.tag=o:N.call(n.tagMap,a)?n.tag=n.tagMap[a]+o:a==="!"?n.tag="!"+o:a==="!!"?n.tag="tag:yaml.org,2002:"+o:g(n,'undeclared tag handle "'+a+'"'),!0}function ra(n){var e,t;if(t=n.input.charCodeAt(n.position),t!==38)return!1;for(n.anchor!==null&&g(n,"duplication of an anchor property"),t=n.input.charCodeAt(++n.position),e=n.position;t!==0&&!S(t)&&!B(t);)t=n.input.charCodeAt(++n.position);return n.position===e&&g(n,"name of an anchor node must contain at least one character"),n.anchor=n.input.slice(e,n.position),!0}function oa(n){var e,t,i;if(i=n.input.charCodeAt(n.position),i!==42)return!1;for(i=n.input.charCodeAt(++n.position),e=n.position;i!==0&&!S(i)&&!B(i);)i=n.input.charCodeAt(++n.position);return n.position===e&&g(n,"name of an alias node must contain at least one character"),t=n.input.slice(e,n.position),N.call(n.anchorMap,t)||g(n,'unidentified alias "'+t+'"'),n.result=n.anchorMap[t],v(n,!0,-1),!0}function G(n,e,t,i,a){var o,r,s,h=1,d=!1,l=!1,c,p,u,j,w,m;if(n.listener!==null&&n.listener("open",n),n.tag=null,n.anchor=null,n.kind=null,n.result=null,o=r=s=rn===t||Le===t,i&&v(n,!0,-1)&&(d=!0,n.lineIndent>e?h=1:n.lineIndent===e?h=0:n.lineIndent<e&&(h=-1)),h===1)for(;aa(n)||ra(n);)v(n,!0,-1)?(d=!0,s=o,n.lineIndent>e?h=1:n.lineIndent===e?h=0:n.lineIndent<e&&(h=-1)):s=!1;if(s&&(s=d||a),(h===1||rn===t)&&(an===t||Ee===t?w=e:w=e+1,m=n.position-n.lineStart,h===1?s&&(Xn(n,m)||ia(n,m,w))||ea(n,w)?l=!0:(r&&ta(n,w)||Zi(n,w)||na(n,w)?l=!0:oa(n)?(l=!0,(n.tag!==null||n.anchor!==null)&&g(n,"alias node should not have any properties")):$i(n,w,an===t)&&(l=!0,n.tag===null&&(n.tag="?")),n.anchor!==null&&(n.anchorMap[n.anchor]=n.result)):h===0&&(l=s&&Xn(n,m))),n.tag===null)n.anchor!==null&&(n.anchorMap[n.anchor]=n.result);else if(n.tag==="?"){for(n.result!==null&&n.kind!=="scalar"&&g(n,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+n.kind+'"'),c=0,p=n.implicitTypes.length;c<p;c+=1)if(j=n.implicitTypes[c],j.resolve(n.result)){n.result=j.construct(n.result),n.tag=j.tag,n.anchor!==null&&(n.anchorMap[n.anchor]=n.result);break}}else if(n.tag!=="!"){if(N.call(n.typeMap[n.kind||"fallback"],n.tag))j=n.typeMap[n.kind||"fallback"][n.tag];else for(j=null,u=n.typeMap.multi[n.kind||"fallback"],c=0,p=u.length;c<p;c+=1)if(n.tag.slice(0,u[c].tag.length)===u[c].tag){j=u[c];break}j||g(n,"unknown tag !<"+n.tag+">"),n.result!==null&&j.kind!==n.kind&&g(n,"unacceptable node kind for !<"+n.tag+'> tag; it should be "'+j.kind+'", not "'+n.kind+'"'),j.resolve(n.result,n.tag)?(n.result=j.construct(n.result,n.tag),n.anchor!==null&&(n.anchorMap[n.anchor]=n.result)):g(n,"cannot resolve a node with !<"+n.tag+"> explicit tag")}return n.listener!==null&&n.listener("close",n),n.tag!==null||n.anchor!==null||l}function sa(n){var e=n.position,t,i,a,o=!1,r;for(n.version=null,n.checkLineBreaks=n.legacy,n.tagMap=Object.create(null),n.anchorMap=Object.create(null);(r=n.input.charCodeAt(n.position))!==0&&(v(n,!0,-1),r=n.input.charCodeAt(n.position),!(n.lineIndent>0||r!==37));){for(o=!0,r=n.input.charCodeAt(++n.position),t=n.position;r!==0&&!S(r);)r=n.input.charCodeAt(++n.position);for(i=n.input.slice(t,n.position),a=[],i.length<1&&g(n,"directive name must not be less than one character in length");r!==0;){for(;W(r);)r=n.input.charCodeAt(++n.position);if(r===35){do r=n.input.charCodeAt(++n.position);while(r!==0&&!L(r));break}if(L(r))break;for(t=n.position;r!==0&&!S(r);)r=n.input.charCodeAt(++n.position);a.push(n.input.slice(t,n.position))}r!==0&&Rn(n),N.call(Vn,i)?Vn[i](n,i,a):on(n,'unknown document directive "'+i+'"')}if(v(n,!0,-1),n.lineIndent===0&&n.input.charCodeAt(n.position)===45&&n.input.charCodeAt(n.position+1)===45&&n.input.charCodeAt(n.position+2)===45?(n.position+=3,v(n,!0,-1)):o&&g(n,"directives end mark is expected"),G(n,n.lineIndent-1,rn,!1,!0),v(n,!0,-1),n.checkLineBreaks&&Ui.test(n.input.slice(e,n.position))&&on(n,"non-ASCII line breaks are interpreted as content"),n.documents.push(n.result),n.position===n.lineStart&&dn(n)){n.input.charCodeAt(n.position)===46&&(n.position+=3,v(n,!0,-1));return}if(n.position<n.length-1)g(n,"end of the stream or a document separator is expected");else return}function He(n,e){n=String(n),e=e||{},n.length!==0&&(n.charCodeAt(n.length-1)!==10&&n.charCodeAt(n.length-1)!==13&&(n+=`
`),n.charCodeAt(0)===65279&&(n=n.slice(1)));var t=new Qi(n,e),i=n.indexOf("\0");for(i!==-1&&(t.position=i,g(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)sa(t);return t.documents}function ha(n,e,t){e!==null&&typeof e=="object"&&typeof t>"u"&&(t=e,e=null);var i=He(n,t);if(typeof e!="function")return i;for(var a=0,o=i.length;a<o;a+=1)e(i[a])}function da(n,e){var t=He(n,e);if(t.length!==0){if(t.length===1)return t[0];throw new A("expected a single document in the stream, but found more")}}var la=ha,ca=da,We={loadAll:la,load:ca},Fe=Object.prototype.toString,Ye=Object.prototype.hasOwnProperty,Nn=65279,ua=9,Q=10,pa=13,ga=32,ma=33,za=34,Tn=35,fa=37,ja=38,ya=39,wa=42,qe=44,va=45,sn=58,xa=61,ka=62,ba=63,Ia=64,Be=91,Ue=93,_a=96,Ge=123,Aa=124,Ke=125,_={};_[0]="\\0";_[7]="\\a";_[8]="\\b";_[9]="\\t";_[10]="\\n";_[11]="\\v";_[12]="\\f";_[13]="\\r";_[27]="\\e";_[34]='\\"';_[92]="\\\\";_[133]="\\N";_[160]="\\_";_[8232]="\\L";_[8233]="\\P";var Sa=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],Ta=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function Ca(n,e){var t,i,a,o,r,s,h;if(e===null)return{};for(t={},i=Object.keys(e),a=0,o=i.length;a<o;a+=1)r=i[a],s=String(e[r]),r.slice(0,2)==="!!"&&(r="tag:yaml.org,2002:"+r.slice(2)),h=n.compiledTypeMap.fallback[r],h&&Ye.call(h.styleAliases,s)&&(s=h.styleAliases[s]),t[r]=s;return t}function Ea(n){var e,t,i;if(e=n.toString(16).toUpperCase(),n<=255)t="x",i=2;else if(n<=65535)t="u",i=4;else if(n<=4294967295)t="U",i=8;else throw new A("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+x.repeat("0",i-e.length)+e}var La=1,$=2;function Pa(n){this.schema=n.schema||Mn,this.indent=Math.max(1,n.indent||2),this.noArrayIndent=n.noArrayIndent||!1,this.skipInvalid=n.skipInvalid||!1,this.flowLevel=x.isNothing(n.flowLevel)?-1:n.flowLevel,this.styleMap=Ca(this.schema,n.styles||null),this.sortKeys=n.sortKeys||!1,this.lineWidth=n.lineWidth||80,this.noRefs=n.noRefs||!1,this.noCompatMode=n.noCompatMode||!1,this.condenseFlow=n.condenseFlow||!1,this.quotingType=n.quotingType==='"'?$:La,this.forceQuotes=n.forceQuotes||!1,this.replacer=typeof n.replacer=="function"?n.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Qn(n,e){for(var t=x.repeat(" ",e),i=0,a=-1,o="",r,s=n.length;i<s;)a=n.indexOf(`
`,i),a===-1?(r=n.slice(i),i=s):(r=n.slice(i,a+1),i=a+1),r.length&&r!==`
`&&(o+=t),o+=r;return o}function Cn(n,e){return`
`+x.repeat(" ",n.indent*e)}function Da(n,e){var t,i,a;for(t=0,i=n.implicitTypes.length;t<i;t+=1)if(a=n.implicitTypes[t],a.resolve(e))return!0;return!1}function hn(n){return n===ga||n===ua}function Z(n){return 32<=n&&n<=126||161<=n&&n<=55295&&n!==8232&&n!==8233||57344<=n&&n<=65533&&n!==Nn||65536<=n&&n<=1114111}function $n(n){return Z(n)&&n!==Nn&&n!==pa&&n!==Q}function Zn(n,e,t){var i=$n(n),a=i&&!hn(n);return(t?i:i&&n!==qe&&n!==Be&&n!==Ue&&n!==Ge&&n!==Ke)&&n!==Tn&&!(e===sn&&!a)||$n(e)&&!hn(e)&&n===Tn||e===sn&&a}function Ma(n){return Z(n)&&n!==Nn&&!hn(n)&&n!==va&&n!==ba&&n!==sn&&n!==qe&&n!==Be&&n!==Ue&&n!==Ge&&n!==Ke&&n!==Tn&&n!==ja&&n!==wa&&n!==ma&&n!==Aa&&n!==xa&&n!==ka&&n!==ya&&n!==za&&n!==fa&&n!==Ia&&n!==_a}function Ra(n){return!hn(n)&&n!==sn}function J(n,e){var t=n.charCodeAt(e),i;return t>=55296&&t<=56319&&e+1<n.length&&(i=n.charCodeAt(e+1),i>=56320&&i<=57343)?(t-55296)*1024+i-56320+65536:t}function Ve(n){var e=/^\n* /;return e.test(n)}var Je=1,En=2,Xe=3,Qe=4,q=5;function Oa(n,e,t,i,a,o,r,s){var h,d=0,l=null,c=!1,p=!1,u=i!==-1,j=-1,w=Ma(J(n,0))&&Ra(J(n,n.length-1));if(e||r)for(h=0;h<n.length;d>=65536?h+=2:h++){if(d=J(n,h),!Z(d))return q;w=w&&Zn(d,l,s),l=d}else{for(h=0;h<n.length;d>=65536?h+=2:h++){if(d=J(n,h),d===Q)c=!0,u&&(p=p||h-j-1>i&&n[j+1]!==" ",j=h);else if(!Z(d))return q;w=w&&Zn(d,l,s),l=d}p=p||u&&h-j-1>i&&n[j+1]!==" "}return!c&&!p?w&&!r&&!a(n)?Je:o===$?q:En:t>9&&Ve(n)?q:r?o===$?q:En:p?Qe:Xe}function Na(n,e,t,i,a){n.dump=(function(){if(e.length===0)return n.quotingType===$?'""':"''";if(!n.noCompatMode&&(Sa.indexOf(e)!==-1||Ta.test(e)))return n.quotingType===$?'"'+e+'"':"'"+e+"'";var o=n.indent*Math.max(1,t),r=n.lineWidth===-1?-1:Math.max(Math.min(n.lineWidth,40),n.lineWidth-o),s=i||n.flowLevel>-1&&t>=n.flowLevel;function h(d){return Da(n,d)}switch(Oa(e,s,n.indent,r,h,n.quotingType,n.forceQuotes&&!i,a)){case Je:return e;case En:return"'"+e.replace(/'/g,"''")+"'";case Xe:return"|"+ne(e,n.indent)+ee(Qn(e,o));case Qe:return">"+ne(e,n.indent)+ee(Qn(Ha(e,r),o));case q:return'"'+Wa(e)+'"';default:throw new A("impossible error: invalid scalar style")}})()}function ne(n,e){var t=Ve(n)?String(e):"",i=n[n.length-1]===`
`,a=i&&(n[n.length-2]===`
`||n===`
`),o=a?"+":i?"":"-";return t+o+`
`}function ee(n){return n[n.length-1]===`
`?n.slice(0,-1):n}function Ha(n,e){for(var t=/(\n+)([^\n]*)/g,i=(function(){var d=n.indexOf(`
`);return d=d!==-1?d:n.length,t.lastIndex=d,te(n.slice(0,d),e)})(),a=n[0]===`
`||n[0]===" ",o,r;r=t.exec(n);){var s=r[1],h=r[2];o=h[0]===" ",i+=s+(!a&&!o&&h!==""?`
`:"")+te(h,e),a=o}return i}function te(n,e){if(n===""||n[0]===" ")return n;for(var t=/ [^ ]/g,i,a=0,o,r=0,s=0,h="";i=t.exec(n);)s=i.index,s-a>e&&(o=r>a?r:s,h+=`
`+n.slice(a,o),a=o+1),r=s;return h+=`
`,n.length-a>e&&r>a?h+=n.slice(a,r)+`
`+n.slice(r+1):h+=n.slice(a),h.slice(1)}function Wa(n){for(var e="",t=0,i,a=0;a<n.length;t>=65536?a+=2:a++)t=J(n,a),i=_[t],!i&&Z(t)?(e+=n[a],t>=65536&&(e+=n[a+1])):e+=i||Ea(t);return e}function Fa(n,e,t){var i="",a=n.tag,o,r,s;for(o=0,r=t.length;o<r;o+=1)s=t[o],n.replacer&&(s=n.replacer.call(t,String(o),s)),(P(n,e,s,!1,!1)||typeof s>"u"&&P(n,e,null,!1,!1))&&(i!==""&&(i+=","+(n.condenseFlow?"":" ")),i+=n.dump);n.tag=a,n.dump="["+i+"]"}function ie(n,e,t,i){var a="",o=n.tag,r,s,h;for(r=0,s=t.length;r<s;r+=1)h=t[r],n.replacer&&(h=n.replacer.call(t,String(r),h)),(P(n,e+1,h,!0,!0,!1,!0)||typeof h>"u"&&P(n,e+1,null,!0,!0,!1,!0))&&((!i||a!=="")&&(a+=Cn(n,e)),n.dump&&Q===n.dump.charCodeAt(0)?a+="-":a+="- ",a+=n.dump);n.tag=o,n.dump=a||"[]"}function Ya(n,e,t){var i="",a=n.tag,o=Object.keys(t),r,s,h,d,l;for(r=0,s=o.length;r<s;r+=1)l="",i!==""&&(l+=", "),n.condenseFlow&&(l+='"'),h=o[r],d=t[h],n.replacer&&(d=n.replacer.call(t,h,d)),P(n,e,h,!1,!1)&&(n.dump.length>1024&&(l+="? "),l+=n.dump+(n.condenseFlow?'"':"")+":"+(n.condenseFlow?"":" "),P(n,e,d,!1,!1)&&(l+=n.dump,i+=l));n.tag=a,n.dump="{"+i+"}"}function qa(n,e,t,i){var a="",o=n.tag,r=Object.keys(t),s,h,d,l,c,p;if(n.sortKeys===!0)r.sort();else if(typeof n.sortKeys=="function")r.sort(n.sortKeys);else if(n.sortKeys)throw new A("sortKeys must be a boolean or a function");for(s=0,h=r.length;s<h;s+=1)p="",(!i||a!=="")&&(p+=Cn(n,e)),d=r[s],l=t[d],n.replacer&&(l=n.replacer.call(t,d,l)),P(n,e+1,d,!0,!0,!0)&&(c=n.tag!==null&&n.tag!=="?"||n.dump&&n.dump.length>1024,c&&(n.dump&&Q===n.dump.charCodeAt(0)?p+="?":p+="? "),p+=n.dump,c&&(p+=Cn(n,e)),P(n,e+1,l,!0,c)&&(n.dump&&Q===n.dump.charCodeAt(0)?p+=":":p+=": ",p+=n.dump,a+=p));n.tag=o,n.dump=a||"{}"}function ae(n,e,t){var i,a,o,r,s,h;for(a=t?n.explicitTypes:n.implicitTypes,o=0,r=a.length;o<r;o+=1)if(s=a[o],(s.instanceOf||s.predicate)&&(!s.instanceOf||typeof e=="object"&&e instanceof s.instanceOf)&&(!s.predicate||s.predicate(e))){if(t?s.multi&&s.representName?n.tag=s.representName(e):n.tag=s.tag:n.tag="?",s.represent){if(h=n.styleMap[s.tag]||s.defaultStyle,Fe.call(s.represent)==="[object Function]")i=s.represent(e,h);else if(Ye.call(s.represent,h))i=s.represent[h](e,h);else throw new A("!<"+s.tag+'> tag resolver accepts not "'+h+'" style');n.dump=i}return!0}return!1}function P(n,e,t,i,a,o,r){n.tag=null,n.dump=t,ae(n,t,!1)||ae(n,t,!0);var s=Fe.call(n.dump),h=i,d;i&&(i=n.flowLevel<0||n.flowLevel>e);var l=s==="[object Object]"||s==="[object Array]",c,p;if(l&&(c=n.duplicates.indexOf(t),p=c!==-1),(n.tag!==null&&n.tag!=="?"||p||n.indent!==2&&e>0)&&(a=!1),p&&n.usedDuplicates[c])n.dump="*ref_"+c;else{if(l&&p&&!n.usedDuplicates[c]&&(n.usedDuplicates[c]=!0),s==="[object Object]")i&&Object.keys(n.dump).length!==0?(qa(n,e,n.dump,a),p&&(n.dump="&ref_"+c+n.dump)):(Ya(n,e,n.dump),p&&(n.dump="&ref_"+c+" "+n.dump));else if(s==="[object Array]")i&&n.dump.length!==0?(n.noArrayIndent&&!r&&e>0?ie(n,e-1,n.dump,a):ie(n,e,n.dump,a),p&&(n.dump="&ref_"+c+n.dump)):(Fa(n,e,n.dump),p&&(n.dump="&ref_"+c+" "+n.dump));else if(s==="[object String]")n.tag!=="?"&&Na(n,n.dump,e,o,h);else{if(s==="[object Undefined]")return!1;if(n.skipInvalid)return!1;throw new A("unacceptable kind of an object to dump "+s)}n.tag!==null&&n.tag!=="?"&&(d=encodeURI(n.tag[0]==="!"?n.tag.slice(1):n.tag).replace(/!/g,"%21"),n.tag[0]==="!"?d="!"+d:d.slice(0,18)==="tag:yaml.org,2002:"?d="!!"+d.slice(18):d="!<"+d+">",n.dump=d+" "+n.dump)}return!0}function Ba(n,e){var t=[],i=[],a,o;for(Ln(n,t,i),a=0,o=i.length;a<o;a+=1)e.duplicates.push(t[i[a]]);e.usedDuplicates=new Array(o)}function Ln(n,e,t){var i,a,o;if(n!==null&&typeof n=="object")if(a=e.indexOf(n),a!==-1)t.indexOf(a)===-1&&t.push(a);else if(e.push(n),Array.isArray(n))for(a=0,o=n.length;a<o;a+=1)Ln(n[a],e,t);else for(i=Object.keys(n),a=0,o=i.length;a<o;a+=1)Ln(n[i[a]],e,t)}function Ua(n,e){e=e||{};var t=new Pa(e);t.noRefs||Ba(n,t);var i=n;return t.replacer&&(i=t.replacer.call({"":i},"",i)),P(t,0,i,!0,!0)?t.dump+`
`:""}var Ga=Ua,Ka={dump:Ga};function Hn(n,e){return function(){throw new Error("Function yaml."+n+" is removed in js-yaml 4. Use yaml."+e+" instead, which is now safe by default.")}}var Va=b,Ja=ue,Xa=ze,Qa=ve,$a=xe,Za=Mn,nr=We.load,er=We.loadAll,tr=Ka.dump,ir=A,ar={binary:Ae,float:we,map:me,null:fe,pairs:Te,set:Ce,timestamp:Ie,bool:je,int:ye,merge:_e,omap:Se,seq:ge,str:pe},rr=Hn("safeLoad","load"),or=Hn("safeLoadAll","loadAll"),sr=Hn("safeDump","dump"),hr={Type:Va,Schema:Ja,FAILSAFE_SCHEMA:Xa,JSON_SCHEMA:Qa,CORE_SCHEMA:$a,DEFAULT_SCHEMA:Za,load:nr,loadAll:er,dump:tr,YAMLException:ir,types:ar,safeLoad:rr,safeLoadAll:or,safeDump:sr};const dr=Object.assign({"./chapters/en/beginner/city-and-transportation.yml":ht,"./chapters/en/beginner/clothes-and-shopping.yml":dt,"./chapters/en/beginner/family-and-friends.yml":lt,"./chapters/en/beginner/food-and-eating.yml":ct,"./chapters/en/beginner/health-and-body.yml":ut,"./chapters/en/beginner/hobbies-and-free-time.yml":pt,"./chapters/en/beginner/home-and-living.yml":gt,"./chapters/en/beginner/morning-routine.yml":mt,"./chapters/en/beginner/time-and-schedules.yml":zt,"./chapters/en/beginner/weather-and-seasons.yml":ft,"./chapters/en/intermediate/03-future-and-plans.yml":jt,"./chapters/en/intermediate/04-experiences-and-achievements.yml":yt,"./chapters/en/intermediate/05-travel-problems.yml":wt,"./chapters/en/intermediate/06-opinions-and-disagreement.yml":vt,"./chapters/en/intermediate/07-describing-personality.yml":xt,"./chapters/en/intermediate/08-entertainment-and-reviews.yml":kt,"./chapters/en/intermediate/identity-and-background.yml":bt,"./chapters/en/intermediate/telling-stories.yml":It,"./chapters/ja/beginner/comprehension-check.yml":_t,"./chapters/ja/beginner/me-and-you.yml":At,"./chapters/ja/beginner/me-you-and-professionals.yml":St,"./chapters/ja/beginner/mixed-practice-dialogue-flow.yml":Tt,"./chapters/ja/beginner/negative-not-x.yml":Ct,"./chapters/ja/beginner/shadowing-speed-rhythm.yml":Et,"./chapters/ja/beginner/stating-facts.yml":Lt,"./chapters/ja/beginner/yes-no-questions.yml":Pt,"./chapters/ja/foundation/hiragana-01-vowels-k.yml":Dt,"./chapters/ja/foundation/hiragana-02-s-t.yml":Mt,"./chapters/ja/foundation/hiragana-03-n-h.yml":Rt,"./chapters/ja/foundation/hiragana-04-m-y-r-w.yml":Ot,"./chapters/ja/foundation/hiragana-05-dakuten.yml":Nt,"./chapters/ja/intermediate/discussing-movies.yml":Ht,"./chapters/zh/foundation/pinyin-01-tones.yml":Wt,"./chapters/zh/foundation/pinyin-02-initials.yml":Ft,"./chapters/zh/foundation/pinyin-03-finals.yml":Yt});function lr(n){try{return hr.load(n)}catch(e){return console.error("Failed to parse chapter YAML:",e),null}}function cr(n){const e=n.match(/\.\/chapters\/([a-z]{2})\//);return e?e[1]:null}function ur(n,e,t="en"){return n?.words?n.words.map((i,a)=>{const o=i.word[e]||i.word.en,r=i.word[t]||i.word.en;return{id:`${n.meta.id}_${i.id}`,word:o,nativeWord:r,meaning:i.description[e]||i.description.en,nativeMeaning:i.description[t]||i.description.en,example:i.sentence[e]||i.sentence.en,nativeExample:i.sentence[t]||i.sentence.en,phonetic:e==="en"?i.phonetic:void 0,reading:e==="ja"?i.reading:void 0}}):[]}function pr(){const n={};for(const[e,t]of Object.entries(dr)){const i=cr(e);if(!i)continue;const a=lr(t);a?.meta&&(a.meta.targetLanguage=i,n[i]||(n[i]=[]),n[i].push(a))}for(const e of Object.keys(n))n[e].sort((t,i)=>(t.meta.order||999)-(i.meta.order||999));return n}let mn=null;function gr(){return mn||(mn=pr()),mn}function $e(n="ja"){return gr()[n]||[]}function Ze(n="ja",e="en"){return $e(n).map(i=>({id:i.meta.id,title:i.meta.title[e]||i.meta.title.en,description:i.meta.description[e]||i.meta.description.en,icon:i.meta.icon,level:i.meta.level,type:i.meta.type||"chapter",targetLanguage:i.meta.targetLanguage,wordCount:i.words?.length||0,characterCount:i.characters?.length||0,order:i.meta.order}))}function mr(n="ja",e="beginner",t="en"){return Ze(n,t).filter(i=>i.level===e)}function Wn(n,e="ja"){return $e(e).find(i=>i.meta.id===n)}function Ar(n,e="ja",t="en"){const i=Wn(n,e);return i?ur(i,e,t):[]}function Sr(n,e="ja",t="en"){const i=Wn(n,e);return i?.chat?.conversations?i.chat.conversations.map(a=>({id:a.id,title:a.title[e]||a.title.en,messages:a.messages.map(o=>({role:o.role,text:o.text[e]||o.text.en,nativeText:o.text[t]||o.text.en}))})):[]}function re(n="ja",e="en"){return Ze(n,e).filter(t=>t.level==="foundation")}function Tr(n,e="ja",t="en"){const i=Wn(n,e);return i?.characters?i.characters.map(a=>({id:`${i.meta.id}_${a.id}`,char:a.char,reading:a.reading,romaji:a.romaji,strokeCount:a.stroke_count,mnemonic:a.mnemonic?.[t]||a.mnemonic?.en,audioHint:a.audio_hint,tone:a.tone,toneDescription:a.tone_description?.[t]||a.tone_description?.en,row:a.row,examples:(a.examples||[]).map(o=>({word:o.word,reading:o.reading,meaning:o.meaning[t]||o.meaning.en}))})):[]}const nt="chatmate_learningProgress",oe={chapters:{},stats:{totalQuizzesPassed:0,totalConversationsCompleted:0}};function zr(){try{const n=localStorage.getItem(nt);return n?JSON.parse(n):{...oe}}catch(n){return console.error("Failed to load learning progress:",n),{...oe}}}function fr(n){try{localStorage.setItem(nt,JSON.stringify(n))}catch(e){console.error("Failed to save learning progress:",e)}}const T=E(zr());function se(n){return T.value.chapters[n]||(T.value.chapters[n]={quizCompleted:!1,quizScore:0,quizBestScore:0,conversationCompleted:!1}),T.value.chapters[n]}function zn(){fr(T.value)}function jr(){function n(d,l,c){const p=se(d),u=Math.round(l/c*100);return u>p.quizBestScore&&(p.quizBestScore=u),p.quizScore=u,u>=60&&!p.quizCompleted&&(p.quizCompleted=!0,T.value.stats.totalQuizzesPassed++),zn(),{percentage:u,passed:u>=60}}function e(d){return T.value.chapters[d]?.quizCompleted||!1}function t(d){return T.value.chapters[d]?.quizBestScore||0}function i(d){const l=se(d);l.conversationCompleted||(l.conversationCompleted=!0,T.value.stats.totalConversationsCompleted++,zn())}function a(d){return T.value.chapters[d]?.conversationCompleted||!1}function o(d){const l=T.value.chapters[d];return l?l.quizCompleted&&l.conversationCompleted:!1}function r(d){const l=T.value.chapters[d];return l?{quiz:l.quizCompleted,conversation:l.conversationCompleted,complete:l.quizCompleted&&l.conversationCompleted,quizBestScore:l.quizBestScore||0}:{quiz:!1,conversation:!1,complete:!1,quizBestScore:0}}const s=R(()=>T.value.stats);function h(){T.value={chapters:{},stats:{totalQuizzesPassed:0,totalConversationsCompleted:0}},zn()}return{markQuizCompleted:n,isQuizCompleted:e,getQuizBestScore:t,markConversationCompleted:i,isConversationCompleted:a,isChapterCompleted:o,getChapterCompletionStatus:r,stats:s,resetProgress:h}}const et="chatmate_preLessonProgress",nn={lessons:{},stats:{totalCharactersLearned:0,totalPreLessonsCompleted:0}};function yr(){try{const n=localStorage.getItem(et);return n?JSON.parse(n):{...nn,stats:{...nn.stats},lessons:{}}}catch(n){return console.error("Failed to load pre-lesson progress:",n),{...nn,stats:{...nn.stats},lessons:{}}}}function wr(n){try{localStorage.setItem(et,JSON.stringify(n))}catch(e){console.error("Failed to save pre-lesson progress:",e)}}const I=E(yr());let fn=null;function jn(n){return I.value.lessons[n]||(I.value.lessons[n]={charactersLearned:[],quizCompleted:!1,quizBestScore:0,matchingCompleted:!1}),I.value.lessons[n]}function en(){wr(I.value)}function vr(){function n(m,z){const f=jn(m);f.charactersLearned.includes(z)||(f.charactersLearned.push(z),I.value.stats.totalCharactersLearned++,en(),fn&&fn(m,z))}function e(m,z){return I.value.lessons[m]?.charactersLearned?.includes(z)||!1}function t(m){return I.value.lessons[m]?.charactersLearned||[]}function i(m,z,f){if(f===0)return{percentage:0,passed:!1};const H=jn(m),D=Math.round(z/f*100);if(D>H.quizBestScore&&(H.quizBestScore=D),D>=70){const K=!H.quizCompleted;H.quizCompleted=!0,K&&d()}return en(),{percentage:D,passed:D>=70}}function a(m){return I.value.lessons[m]?.quizCompleted||!1}function o(m){return I.value.lessons[m]?.quizBestScore||0}function r(m){const z=jn(m);z.matchingCompleted||(z.matchingCompleted=!0,en())}function s(m){return I.value.lessons[m]?.matchingCompleted||!1}function h(m){const z=I.value.lessons[m];return z?z.quizCompleted:!1}function d(){const m=Object.values(I.value.lessons).filter(z=>z.quizCompleted).length;I.value.stats.totalPreLessonsCompleted=m}function l(m="ja"){const z=re(m);return z.length===0?!0:z.every(f=>h(f.id))}function c(m="ja"){const{getChapterCompletionStatus:z}=jr();return mr(m,"beginner").some(K=>{const k=z(K.id);return k.quiz||k.conversation})||re(m).length===0?!1:!l(m)}function p(m){const z=I.value.lessons[m];return z?{charactersLearned:z.charactersLearned.length,quizCompleted:z.quizCompleted,quizBestScore:z.quizBestScore,matchingCompleted:z.matchingCompleted,complete:z.quizCompleted}:{charactersLearned:0,quizCompleted:!1,quizBestScore:0,matchingCompleted:!1,complete:!1}}const u=R(()=>I.value.stats);function j(){I.value={lessons:{},stats:{totalCharactersLearned:0,totalPreLessonsCompleted:0}},en()}function w(m){fn=m}return{markCharacterLearned:n,isCharacterLearned:e,getLearnedCharacters:t,markQuizCompleted:i,isQuizCompleted:a,getQuizBestScore:o,markMatchingCompleted:r,isMatchingCompleted:s,isPreLessonCompleted:h,arePreLessonsComplete:l,areChaptersLocked:c,getLessonStatus:p,stats:u,setOnCharacterLearnedCallback:w,resetProgress:j}}const tt="chatmate_userProgress";function Pn(){return{totalXP:0,messagesSent:0,messagesReceived:0,articlesStarted:[],articlesCompleted:[],currentStreak:0,longestStreak:0,lastActiveDate:null,totalSessionMinutes:0,wordsLearned:[],characterStats:{},claimedMilestones:[],unlockedAchievements:[],diaryEntries:0,diaryStreak:0,longestDiaryStreak:0,diaryVocabUsed:0,hasWrittenLongEntry:!1,lastDiaryDate:null,activityLog:{}}}function xr(n=new Date){const e=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),i=String(n.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}function kr(n,e=90){const t=Object.keys(n||{}).sort();if(t.length<=e)return n;const i=t.slice(0,t.length-e);for(const a of i)delete n[a];return n}function yn(n,e,t=0){const i=xr();n.activityLog||(n.activityLog={});const a=n.activityLog[i]||{messages:0,xp:0,diary:0};e==="message"&&(a.messages+=1),e==="diary"&&(a.diary+=1),t&&(a.xp+=t),n.activityLog[i]=a,kr(n.activityLog)}function br(){try{const n=localStorage.getItem(tt);if(n)return{...Pn(),...JSON.parse(n)}}catch{}return Pn()}const y=E(br());let wn=!1;function C(){wn||(wn=!0,queueMicrotask(()=>{localStorage.setItem(tt,JSON.stringify(y.value)),wn=!1}))}let he=!1;function Cr(){const{stats:n,setOnCharacterLearnedCallback:e}=vr();y.value.preLessonStats=n.value,he||(he=!0,at(n,k=>{y.value.preLessonStats=k},{deep:!0}));const{currentRank:t,nextRank:i,xpToNextRank:a,progressToNextRank:o,addXP:r,dismissLevelUp:s,getAllRanks:h}=rt(y,C),{updateStreak:d,dismissStreakMilestone:l}=ot(y,C,r,F),{unlockedAchievements:c,lockedAchievements:p,checkAchievements:u,dismissAchievementUnlock:j}=st(y,C);e(()=>{r(2,"characterLearned"),y.value.preLessonStats=n.value,C(),u()});function w(){d(),y.value.messagesSent+=1,r(F.userMessage,"userMessage"),yn(y.value,"message",F.userMessage),C(),u()}function m(){y.value.messagesReceived+=1,r(F.systemMessage,"systemMessage"),yn(y.value,"message",F.systemMessage),C(),u()}function z(k){y.value.articlesStarted.includes(k)||(y.value.articlesStarted.push(k),C())}function f(k){y.value.wordsLearned.includes(k)||(y.value.wordsLearned.push(k),C())}function H(k){y.value.characterStats[k]||(y.value.characterStats[k]={messages:0}),y.value.characterStats[k].messages+=1,C()}function D({wordCount:k=0,vocabWordsUsed:Fn=0}={}){const Yn=new Date().toDateString(),qn=y.value.lastDiaryDate;if(qn===Yn){k>=200&&(y.value.hasWrittenLongEntry=!0),C(),u();return}y.value.diaryEntries+=1;{const ln=new Date;ln.setDate(ln.getDate()-1),qn===ln.toDateString()?y.value.diaryStreak+=1:y.value.diaryStreak=1,y.value.lastDiaryDate=Yn}y.value.diaryStreak>y.value.longestDiaryStreak&&(y.value.longestDiaryStreak=y.value.diaryStreak),Fn>0&&(y.value.diaryVocabUsed+=Fn),k>=200&&(y.value.hasWrittenLongEntry=!0),yn(y.value,"diary",0),C(),u()}function K(){y.value=Pn(),C()}return{progress:y,recentXPGain:vn,showLevelUp:xn,newRank:kn,showStreakMilestone:bn,currentMilestone:In,showAchievementUnlock:_n,newAchievement:An,currentRank:t,nextRank:i,xpToNextRank:a,progressToNextRank:o,unlockedAchievements:c,lockedAchievements:p,addXP:r,onMessageSent:w,onMessageReceived:m,onArticleStarted:z,onWordLearned:f,trackCharacterInteraction:H,onDiarySubmitted:D,dismissLevelUp:s,dismissStreakMilestone:l,dismissAchievementUnlock:j,checkAchievements:u,getAllRanks:h,resetProgress:K,RANKS:V,XP_REWARDS:F,STREAK_MILESTONES:de,ACHIEVEMENTS:tn}}export{de as S,_r as a,jr as b,vr as c,mr as d,Ar as e,Tr as f,re as g,Sr as h,Cr as u};
